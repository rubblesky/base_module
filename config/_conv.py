...
configs = [
    ...
    dict(
        ...
        config = { 
            'name'      : 'ConvModule',
            'module'    : ConvModule,
            'params'    : dict(in_channels = 2,out_channels = 1,kernel_size = (3,3),stride=1, padding=1, dilation=1, groups=1, bias=True),
    ...
    dict(
        ...
        config = { 
            'name'      : 'ConvModule',
            'module'    : ConvModule,
            'params'    : dict(in_channels = 1,out_channels = 3,kernel_size = (3,3),stride=1, padding=1, dilation=1, groups=1, bias=True),
